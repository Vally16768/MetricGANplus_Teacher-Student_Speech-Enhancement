...
3. Read the active execution board named by `.agents/INDEX.md`
   (`.agents/TEACHER_T7_TODO.md` for T7), then only the other
...
- Treat `.agents/TEACHER_T7_TODO.md` as the detailed source of truth for the
  active T7 sequence. Treat `.agents/TEACHER_T6_TODO.md`,

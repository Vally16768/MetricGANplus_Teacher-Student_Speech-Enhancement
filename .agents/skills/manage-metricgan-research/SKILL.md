...
3. Read the active execution board named by `.agents/INDEX.md`
   (`.agents/TEACHER_T13_TODO.md` for T13), then only the other
...
- Treat `.agents/TEACHER_T13_TODO.md` as the detailed source of truth for the
  active T13 sequence. Treat `.agents/TEACHER_T12_TODO.md`,
  `.agents/TEACHER_T11_TODO.md`,
  `.agents/TEACHER_T10_TODO.md`,

...
3. Read the active execution board named by `.agents/INDEX.md`
   (`.agents/TEACHER_T6_TODO.md` for T6), then only the other
...
- Treat `.agents/TEACHER_T6_TODO.md` as the detailed source of truth for the
  active T6 sequence. Treat `.agents/TEACHER_T5_TODO.md`,

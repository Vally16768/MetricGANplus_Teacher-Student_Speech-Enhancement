...
3. Read the active execution board named by `.agents/INDEX.md`
   (`.agents/TEACHER_T12_TODO.md` for T12), then only the other
...
- Treat `.agents/TEACHER_T12_TODO.md` as the detailed source of truth for the
  active T12 sequence. Treat `.agents/TEACHER_T11_TODO.md`,

...
3. Read the active execution board named by `.agents/INDEX.md`
   (`.agents/TEACHER_T15_TODO.md` for T15), then only the other
...
- Treat `.agents/TEACHER_T15_TODO.md` as the detailed source of truth for the
  active T15 sequence. Treat `.agents/TEACHER_T14_TODO.md`,

...
| T10.1.3 | Run suite, guard and clean CUDA smoke | 95/95, campaign validation and guard pass; smoke pending | in-progress |
| T10.2.1 | Run fresh 128-example calibration | stop before validation on failure | blocked |

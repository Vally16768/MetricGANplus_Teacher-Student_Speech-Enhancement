...
| `.agents/TEACHER_T9_PLAN.md` | train-only multi-action adaptive-routing successor | canonical active |
| `.agents/TEACHER_T9_TODO.md` | active T9 board and evidence ledger | canonical active |

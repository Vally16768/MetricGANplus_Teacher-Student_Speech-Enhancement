...
| `.agents/TEACHER_T15_PLAN.md` | cross-fitted quadratic calibration successor | canonical active |
| `.agents/TEACHER_T15_TODO.md` | active T15 board and evidence ledger | canonical active |

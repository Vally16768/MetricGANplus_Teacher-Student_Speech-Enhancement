...
| C44 | Repair post-evaluation resume robustness | deterministic interrupt/resume equivalence for LR, patience, best state and checkpoint; unit/guard/CUDA smoke | blocked |

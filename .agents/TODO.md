...
| C36 | Run the full official baseline | launch `20260727-official-baseline-full-s0-a1` from clean commit; full frozen manifests, official FP16 cache, 20-epoch fresh WB/NB students | in-progress |

...
2. Read `.agents/TEACHER_T7_TODO.md` and reconcile its active item with
   evidence. Use `.agents/TEACHER_T5_TODO.md`, `.agents/TEACHER_T4_TODO.md`,
   `.agents/TEACHER_T6_TODO.md`, `.agents/TEACHER_SUCCESSOR_TODO.md` and
   `.agents/EXECUTION_TODO.md` for completed predecessor evidence.
